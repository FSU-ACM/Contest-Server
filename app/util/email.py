...
def sign_in_email(address, domuser, dompass):
    ...
    msg.body += "Password: {0} \n".format(dompass)
    msg.body += "\n"
    msg.body += "Log in at domjudge.cs.fsu.edu.\n"
    msg.body += "\nRegards,\nACM at FSU"
...
def quick_register_email(address, password):
    ...
    msg.body += "In order to get extra credit, please go to bastion.cs.fsu.edu/account and add any courses you are currently taking.\n\n"
    msg.body += "If you think you're getting this email as an error, let us know at contact@fsu.acm.org.\n\n"
    msg.body += "Regards,\nACM at FSU"
